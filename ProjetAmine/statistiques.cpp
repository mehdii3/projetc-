      ...
      int i =0;
       ...
       fossil->setBrush(QColor(111, 9, 176));
         ...
         /* QCPBars *regen = new QCPBars(ui->widget->xAxis, ui->widget->yAxis);
          ...
          query.prepare("SELECT  id FROM vols");
          query.exec();
          ...
          while(query.next())
          {
           ...
           query1.prepare("SELECT nb_place FROM vols where id = '"+query.value(0).toString()+"' ");
           query1.exec();
           while (query1.next()) {
         ...
         // ticks << 1 << 2 << 3 ;
          ...
          ui->widget->yAxis->setLabel("Nombre de places reservées par vol");
