...
depot:: depot(QString Ref,QString ,int cap_max)
{
  this->Ref=Ref;
  this->nom=nom;
  this->cap_max=cap_max;
}
QString depot::get_Ref(){return Ref;}
QString depot::get_nom(){return nom;}
int depot::get_cap_max(){return cap_max;}

bool depot::ajouter_dep()
{
QSqlQuery query;
...
QSqlQueryModel * depot::afficher_dep()
{QSqlQueryModel * model= new QSqlQueryModel();
...
bool depot::supprimer_dep(QString)
{
QSqlQuery query;
